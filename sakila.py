...
select first_name, last_name, email, city_id, address.address
from customer
...
select actor.actor_id, actor.first_name, film.title, film.description, 
film.release_year
from film
...
film.special_features, category.name as genre, film.rental_rate
from film
join film_category on film_category.film_id = film.film_id
join category on category.category_id = film_category.category_id
...
select film.title, film.description, film.release_year, film.rating, 
film.special_features, category.name as genre, actor.first_name, actor.last_name
from film
join film_category on film_category.film_id = film.film_id
join category on category.category_id = film_category.category_id
join film_actor on film_actor.film_id = film.film_id
